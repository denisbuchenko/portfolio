...
export const CONFIG = {
  ...
  traceGame: {
    ...
    spacingPx: 22, // шаг точек по пути (меньше = сложнее/точнее)

    // Старт:
    startRadiusPx: 26, // насколько близко нужно нажать к первой точке, чтобы стартовать

    // Прогресс:
    reachRadiusPx: 50, // когда цель считается достигнутой и можно идти к следующей
